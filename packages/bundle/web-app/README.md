...
| File | Role |
|---|---|
| [`src/index.ts`](src/index.ts) | The `web-app` glue plugin: dist resolution, LAN trust sampling, product-version injection, prompt sections, bash variable, URL line, browser handoff |
